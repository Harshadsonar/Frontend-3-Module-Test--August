...
function getCurrentImageOfTheDay() {
    ...
    const apikey1 = `FCwnuUpmnMdLNwkKS5bXXNcqrKpvvYpfppEMUxd3`
...
function getImageOfTheDay(date) {
    const apikey2 = `FCwnuUpmnMdLNwkKS5bXXNcqrKpvvYpfppEMUxd3`
...
async function fetchData(date) {
    const apiKey3 = `FCwnuUpmnMdLNwkKS5bXXNcqrKpvvYpfppEMUxd3`
